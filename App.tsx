      ...
      <main>
        ...
        {activeView === 'game' && currentGame && (
          <BoardView
            ...
            onPayJailFine={() => socket.emit('pay_jail_fine', { gameId: currentGame.id, playerId: user?.id })}
            onUseJailCard={() => socket.emit('use_jail_card', { gameId: currentGame.id, playerId: user?.id })}
